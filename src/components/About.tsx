...
export function About() {
  return (
    <section id="about" className="grid border-t border-border lg:grid-cols-2">
      <div className="border-border bg-white px-6 py-[52px] lg:border-r lg:px-12">
        ...
        <p className="mb-3.5 font-sans text-sm leading-[1.8] text-muted">
      ...
      <div className="bg-rose-pale px-6 py-[52px] lg:px-12">
